...
% \item    $ p \vDash_{\mathcal{C}} (\phi \lor \psi)     \Leftrightarrow p \vDash_{\mathcal{C}} \phi$ or $p \vDash_{\mathcal{C}} \psi$ \\
    ...
    \column{0.5\textwidth}
        \begin{tikzpicture}
            ...
            % Fourth stage nodes
            \node (n3) at (0,-4.5) {\textcolor{white}{$T_{00} \neg \alpha$}};

    
            
            % Fifth stage nodes
            \node (n4) at (0,-5.5) {\textcolor{white}{$F_{00} \alpha$}};

    
            \node (n5) at (0,-6.5) {\textcolor{white}{$T_{00} \neg \alpha$}};

    
            \node (n6) at (0,-7.5) {\textcolor{white}{X}};
...
% \item    $ p \vDash_{\mathcal{C}} (\phi \lor \psi)     \Leftrightarrow p \vDash_{\mathcal{C}} \phi$ or $p \vDash_{\mathcal{C}} \psi$ \\
    ...
    \begin{tikzpicture}
        ...
        % Fifth stage nodes
        \node (n4) at (0,-5.5) {$F_{00} \alpha$};
        \draw[->] (n3) -- (n4);

        \node (n5) at (0,-6.5) {$T_{00}  \alpha$};
        \draw[->] (n4) -- (n5);
...
\begin{frame}{Cumulative Tableaux}
    \centering
        ...
        \begin{tikzpicture}
            ...
            % Second stage nodes
            \node (n1) at (0,-1.5) {$T_{\emptyset} \alpha$};
            \draw[->] (root) -- (n1);
            
            % Third stage nodes
            \node (n2) at (0,-3) {$F_{\emptyset} \neg \neg \alpha$};
            \draw[->] (n1) -- (n2);
            
            % Fourth stage nodes
            \node (n3) at (0,-4.5) {$T_{\emptyset} \neg \alpha$};
            \draw[->] (n2) -- (n3);

            
            % Fifth stage nodes
            \node (n4) at (0,-6) {$F_{\emptyset} \alpha$};
            \draw[->] (n3) -- (n4);

            \node (n5) at (0,-7.5) {$T_{\emptyset}  \alpha$};
            \draw[->] (n4) -- (n5);
        ...
        \begin{tikzpicture}
            ...
            % Third stage nodes
            \node (n2) at (0,-3) {$F_{\emptyset} \alpha \to \neg \neg \alpha, T_{\emptyset} \alpha, F_{\emptyset} \neg \neg \alpha$};
            \draw[->] (root) -- (n2);
            
            % Fourth stage nodes
            \node (n3) at (0,-4.5) {$F_{\emptyset} \alpha \to \neg \neg \alpha, T_{\emptyset} \alpha, F_{\emptyset} \neg \neg \alpha, T_{\emptyset} \neg \alpha$};
            \draw[->] (n2) -- (n3);
            
            % Fifth stage nodes
            \node (n4) at (0,-6) {$F_{\emptyset} \alpha \to \neg \neg \alpha, T_{\emptyset} \alpha, F_{\emptyset} \neg \neg \alpha, T_{\emptyset} \neg \alpha, F_{\emptyset} \alpha$};
            \draw[->] (n3) -- (n4);


            \node (n5) at (0,-7.5) {$F_{\emptyset} \alpha \to \neg \neg \alpha, T_{\emptyset} \alpha, F_{\emptyset} \neg \neg \alpha, T_{\emptyset} \neg \alpha, F_{\emptyset} \alpha , T_{\emptyset} \alpha$};
            \draw[->] (n4) -- (n5);
