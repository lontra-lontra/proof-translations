...
\def\wellBehavedTheorem{
    ...
    \end{theorem}
    \begin{proof}
        \cite{book1} proves this by using the definition of forcing. We will de most complex case, that has the most part of the ideas needed for the other ones:
...
\begin {definition}
    ...
    A intuitionistic squent proof tree gives  a intuitionistic sequent proof tree development with axioms on all leafs.
\end {definition} 
...
\begin {definition}
    ...
    A classical sequent proof tree gives a classical sequent proof tree development with axioms on all leaves.
\end {definition} 
...
\def\localTranslationValidityTheorem{
    \begin{theorem}
       ...
       is a classically admissible rule.
...
\begin{definition} \textbf{Tree Thinning Function}
    ...
    \begin{itemize}
        ...
        with a corresponding subtree $\tau_0$ and  $r'_0$ is the root of $\mathcal{F}(\tau_0)$:
         ...
         $r'_0 $ are the elements necessary to the thinned proof $\tau_0$.
        ...
        \item
         ...
         then $((f(\sigma,r)[1] - r)\cap r'_1)  \cup ((f(\sigma,r)[2] - r)\cap r'_2)$ also defines if f was "usefull":
    ...
    \begin{proof}
        ...
        \begin{itemize}
            ...
            \item
             ...
             by induction hipotesis $\#(r'_0) \leq 2$ and so $\#[ (r'_0 - f(\sigma,\sigma)):\sigma ] \leq 2$ 
    ...
    \begin{proof}
        ...
        \begin{itemize}
            ...
            \item
             ...
             By induction hipotesis, we know $r'_0$ to . We also know that the intuitionistic validity of $\sigma$ 
             implies the intuitionistic validity of  $f(\sigma,\sigma)$:
